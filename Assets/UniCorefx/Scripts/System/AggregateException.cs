...
namespace System
{
    ...
    public class AggregateException : Exception
    {
        ...
        public AggregateException()
            : base(_Environment.GetResourceString("AggregateException_ctor_DefaultMessage"))
        {
        ...
        public AggregateException(IEnumerable<Exception> innerExceptions) :
            this(_Environment.GetResourceString("AggregateException_ctor_DefaultMessage"), innerExceptions)
        {
        }
            ...
            : base(message, innerExceptions != null && innerExceptions.Count > 0 ? innerExceptions[0] : null)
        {
            ...
            for (int i = 0; i < exceptionsCopy.Length; i++)
            {
                ...
                {
                    throw new ArgumentException(_Environment.GetResourceString("AggregateException_ctor_InnerExceptionNull"));
                }
            }
        ...
        internal AggregateException(IEnumerable<ExceptionDispatchInfo> innerExceptionInfos) :
            this(_Environment.GetResourceString("AggregateException_ctor_DefaultMessage"), innerExceptionInfos)
        {
        }
            ...
            base(info, context)
        {
            ...
            if (innerExceptions == null)
            {
                throw new SerializationException(_Environment.GetResourceString("AggregateException_DeserializationFailure"));
            }
        ...
        public override string ToString()
        {
            ...
            for (int i = 0; i < m_innerExceptions.Count; i++)
            {
                text = String.Format(
                    ...
                    _Environment.GetResourceString("AggregateException_ToString"),
