...
namespace System.Threading
{
    ...
    public static class LazyInitializer
    {
        ...
        private static T EnsureInitializedCore<T>(ref T target, Func<T> valueFactory) where T : class
        {
            ...
            if (value == null)
            {
                throw new InvalidOperationException(_Environment.GetResourceString("Lazy_StaticInit_InvalidOperation"));
            }
    ...
    static class LazyHelpers<T>
    {
        ...
        private static T ActivatorFactorySelector()
        {
            ...
            {
                throw new MissingMemberException(_Environment.GetResourceString("Lazy_CreateValue_NoParameterlessCtorForT"));
            }
        }
    }
}
